...
export function render(view) {
  ...
  refresh = () => { button.hidden = installed() || !canInstall(); button.style.display = button.hidden ? "none" : ""; status.textContent = installed() ? 'Você já está usando o FoodCourt como aplicativo.' : canInstall() ? 'A instalação está disponível neste navegador.' : 'Siga as instruções abaixo para adicionar o FoodCourt.'; };
