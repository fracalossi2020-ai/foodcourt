  ...
  function drawDelivery(body) {
    ...
    body.innerHTML = `
      ...
      <div class="delivery-choice-list">
        ...
        ${deliveryCard('priority', 'Prioridade FoodCourt', `${Math.max(10, (rest?.deliveryTime?.[0] ?? 25) - 8)}–${Math.max(15, (rest?.deliveryTime?.[1] ?? 40) - 10)} min`, hasDistancePricing ? 'Frete calculado + R$ 4,90' : money(fee + 4.9), 'Seu pedido recebe prioridade operacional para ser preparado e enviado mais rapidamente.')}
      </div>
